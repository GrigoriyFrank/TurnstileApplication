...
//--- (YGenericSensor definitions)
    ...
    public static YGenericSensor FindGenericSensor(String func)
    {
        ...
        synchronized (YAPI.class) {
            obj = (YGenericSensor) _FindFromCache("GenericSensor", func);
            if (obj == null) {
                obj = new YGenericSensor(func);
                _AddToCache("GenericSensor", func, obj);
            }
        }
        return obj;
    }
    ...
    public static YGenericSensor FindGenericSensorInContext(YAPIContext yctx,String func)
    {
        YGenericSensor obj;
        synchronized (yctx) {
            obj = (YGenericSensor) _FindFromCacheInContext(yctx, "GenericSensor", func);
            if (obj == null) {
