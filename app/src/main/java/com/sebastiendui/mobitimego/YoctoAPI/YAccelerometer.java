...
//--- (YAccelerometer definitions)
    ...
    public static YAccelerometer FindAccelerometer(String func)
    {
        ...
        synchronized (YAPI.class) {
            obj = (YAccelerometer) _FindFromCache("Accelerometer", func);
            if (obj == null) {
                obj = new YAccelerometer(func);
                _AddToCache("Accelerometer", func, obj);
            }
        }
        return obj;
    }
    ...
    public static YAccelerometer FindAccelerometerInContext(YAPIContext yctx,String func)
    {
        YAccelerometer obj;
        synchronized (yctx) {
            obj = (YAccelerometer) _FindFromCacheInContext(yctx, "Accelerometer", func);
            if (obj == null) {
