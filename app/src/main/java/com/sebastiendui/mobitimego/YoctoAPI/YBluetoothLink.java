...
//--- (YBluetoothLink definitions)
    ...
    public static YBluetoothLink FindBluetoothLink(String func)
    {
        ...
        synchronized (YAPI.class) {
            obj = (YBluetoothLink) _FindFromCache("BluetoothLink", func);
            if (obj == null) {
                obj = new YBluetoothLink(func);
                _AddToCache("BluetoothLink", func, obj);
            }
        }
        return obj;
    }
    ...
    public static YBluetoothLink FindBluetoothLinkInContext(YAPIContext yctx,String func)
    {
        YBluetoothLink obj;
        synchronized (yctx) {
            obj = (YBluetoothLink) _FindFromCacheInContext(yctx, "BluetoothLink", func);
            if (obj == null) {
