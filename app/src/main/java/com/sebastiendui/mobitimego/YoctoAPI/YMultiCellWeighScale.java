...
package com.sebastiendui.mobitimego.YoctoAPI;
...
//--- (YMultiCellWeighScale definitions)
    ...
    public static YMultiCellWeighScale FindMultiCellWeighScale(String func)
    {
        ...
        synchronized (YAPI.class) {
            obj = (YMultiCellWeighScale) _FindFromCache("MultiCellWeighScale", func);
            if (obj == null) {
                obj = new YMultiCellWeighScale(func);
                _AddToCache("MultiCellWeighScale", func, obj);
            }
        }
        return obj;
    }
    ...
    public static YMultiCellWeighScale FindMultiCellWeighScaleInContext(YAPIContext yctx,String func)
    {
        YMultiCellWeighScale obj;
        synchronized (yctx) {
            obj = (YMultiCellWeighScale) _FindFromCacheInContext(yctx, "MultiCellWeighScale", func);
            if (obj == null) {
    ...
    public int registerTimedReportCallback(TimedReportCallback callback)
    {
        ...
        sensor = this;
        if (callback != null) {
            _UpdateTimedReportCallbackList(sensor, true);
        } else {
            _UpdateTimedReportCallbackList(sensor, false);
        }
