...
//--- (YCarbonDioxide definitions)
    ...
    public static YCarbonDioxide FindCarbonDioxide(String func)
    {
        ...
        synchronized (YAPI.class) {
            obj = (YCarbonDioxide) _FindFromCache("CarbonDioxide", func);
            if (obj == null) {
                obj = new YCarbonDioxide(func);
                _AddToCache("CarbonDioxide", func, obj);
            }
        }
        return obj;
    }
    ...
    public static YCarbonDioxide FindCarbonDioxideInContext(YAPIContext yctx,String func)
    {
        YCarbonDioxide obj;
        synchronized (yctx) {
            obj = (YCarbonDioxide) _FindFromCacheInContext(yctx, "CarbonDioxide", func);
            if (obj == null) {
