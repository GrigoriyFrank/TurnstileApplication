...
public class CameraSource {
    ...
    /**
     * Starts Camera for {@Link ConfirmationScreen}
     *
     * @return CameraSource
     * @throws IOException
     */
    public synchronized CameraSource startForConfirmationScreen() throws IOException {
        if (camera != null) {
            return this;
        }

        camera = createCameraForConfirmationScreen();
    ...
    /**
     * Creates Camera instance for {@Link ConfirmationScreen}. This instance is used only for turn on and
     * turn off the Camera torch.
     *
     * @return Camera
     * @throws IOException
     */
    private Camera createCameraForConfirmationScreen() throws IOException {
